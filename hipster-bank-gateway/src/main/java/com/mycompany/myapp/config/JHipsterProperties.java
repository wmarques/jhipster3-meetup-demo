...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hipsterBankGateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hipsterBankGateway API";

        private String description = "hipsterBankGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hipsterBankGateway";
