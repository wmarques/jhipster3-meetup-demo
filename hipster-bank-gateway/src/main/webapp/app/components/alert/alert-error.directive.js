(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('hipsterBankGatewayApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-hipsterBankGatewayApp-error');
                var entityKey = httpResponse.headers('X-hipsterBankGatewayApp-params');
                if (errorHeader) {
